...
this.equals)};b.prototype.getData=function(){return 0<arguments.length&&arguments[0]?this.queue:this.queue.slice()};b.prototype.setData=function(a,b){var d=[];a.forEach(function(a){d.push(a)});this.queue=d;this.queueLength=b?b:a.length;this.heapify()};b.prototype.setComparator=function(a){"function"==typeof a&&(this.comparator=a)};b.prototype.getComparator=function(){return this.comparator};b.prototype.setEquals=function(a){"function"==typeof a&&(this.equals=a)};b.prototype.getEquals=function(){return this.equals};
b.prototype.size=function(){return this.queueLength};b.prototype.heapify=function(){for(var a=this.queueLength/2|0;0<=a;a--)f(a,this.queue[a],this.queue,this.queueLength,this.comparator)};b.prototype.clone=function(){return new net.jstege1206.PriorityQueue({comparator:this.comparator,equals:this.equals,data:this.queue.slice()})};net.jstege1206.PriorityQueue=b})();"undefined"!==typeof module&&"undefined"!==typeof module.exports&&(module.exports=exports=PriorityQueue=net.jstege1206.PriorityQueue);
